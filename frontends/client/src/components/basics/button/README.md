...
|参数名|描述|类型|默认值|
|---|---|---|:---:|
|type|按钮的类型，分为五种：次要按钮、主要按钮、线性按钮、文字按钮、气泡按钮。|`'primary' \| 'secondary' \| 'outline' \| 'text' | 'bubble'`|`'secondary'`|
...
|nativeType|设置 `button` 的原生 `type` 属性，可选值参考 [HTML标准](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button#attr-type "_blank")|`string`|`'button'`|
